  ...
  if (G_UNLIKELY (underline))
    {
      ...
      if (!span_parse_enum ("underline", underline, PANGO_TYPE_UNDERLINE, (gint *)&ul, line_number, error))
	goto error;
  ...
  if (G_UNLIKELY (gravity))
    {
      ...
      if (!span_parse_enum ("gravity", gravity, PANGO_TYPE_GRAVITY, (gint *)&gr, line_number, error))
	goto error;
  ...
  if (G_UNLIKELY (gravity_hint))
    {
      ...
      if (!span_parse_enum ("gravity_hint", gravity_hint, PANGO_TYPE_GRAVITY_HINT, (gint *)&hint, line_number, error))
	goto error;
