/* config.h  Manually edited for Symbian OS from config.h.in.  */
...
#define PACKAGE_STRING "pango-1.22.2"
...
/* PANGO micro version */
#define PANGO_VERSION_MICRO 22

/* PANGO minor version */
#define PANGO_VERSION_MINOR 2
